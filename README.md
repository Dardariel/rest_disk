Утилита отслеживает все примонтированные устройства хранения инфомации, определяет из текущее заполнение и оповещает оператора если на диске остается меньше указанного объема.
